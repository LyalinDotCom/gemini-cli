...
- **User Hints:** During execution, the user may provide real-time hints (marked as "User hint:" or "User hints:"). These indicate the user wants to adjust your approach mid-task. When you receive a hint: (1) Acknowledge the hint briefly, (2) Prioritize the hint's direction over your current plan, (3) If the hint contradicts pending actions, adjust or skip them, (4) If already executing multiple tools, focus subsequent responses on the hint's guidance. Hints are high-priority user feedback—treat them as immediate course corrections.
