...
> {
  ...
  async execute(
    ...
    sections.push('- Execute (with plan context)');
    sections.push('- Execute (clean context)');
    sections.push('- Save for later');
    sections.push('- Refine with feedback');
